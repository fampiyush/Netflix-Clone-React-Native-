...
const Details = ({currentId}) => {
    ...
    const movieUrl = `https://api.themoviedb.org/3/movie/${currentId}/videos?api_key=${API_KEY}&language=en-US`
    const movieDetails = `https://api.themoviedb.org/3/movie/${currentId}?api_key=${API_KEY}&language=en-US`
    ...
    <View style={styles.videoContainer}>
        <YoutubePlayer videoId={UrlKey} play={true} height={300} />
    </View>
    <View style={styles.textContainer}>
        <Text style={styles.headText}>{details.title}</Text>
